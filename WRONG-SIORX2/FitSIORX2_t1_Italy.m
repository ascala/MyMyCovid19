%function [par0 g h S0 H0 R0 C Inc N]=FitItaly();
    ...
    %t0=30; Inc=2*Inc/4;
    %t0=34; Inc=2*Inc/8;
    fun1=@(p,x) SIORX2_t1([p(1) i0 p(3) teps p(5)],x,g,h,S0,H0,R0,X0,C,Inc,N);
    Fun1=@(p,x) SIORX2_t1_model([p(1) i0 p(3) teps p(5)],x,g,h,S0,H0,R0,X0,C,Inc,N);
    %    [ b     i0   t0   teps   eps]
...
Fun2=@(p,x) SIORX2_t2_model(p,x,g,h,S0,H0,R0,X0,C,Inc,N);
