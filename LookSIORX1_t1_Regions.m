...
% subplot(2,2,1); plot(T,sum(q1,2),'b',T,sum(q0,2),'k'); title("no delay - async end")
% subplot(2,2,2); plot(T,sum(z1,2),'b',T,sum(z0,2),'k'); title("no delay - sync end")
% subplot(2,2,3); plot(T,sum(y1,2),'b',T,sum(y0,2),'k'); title("delay - async end")
% subplot(2,2,4); plot(T,sum(w1,2),'b',T,sum(w0,2),'k'); title("delay - sync end")
% hold off
